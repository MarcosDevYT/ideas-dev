    ...
    <Container className="overflow-hidden">
      <div className="max-w-6xl mx-auto">
        <div className="relative rounded-3xl overflow-hidden bg-card border border-border shadow-2xl text-center py-20 px-6">
          ...
          <div className="absolute inset-0 bg-linear-to-br from-primary/10 via-background to-secondary/10 -z-10" />
          {/* Círculo luminoso en el fondo de la caja */}
          <div className="absolute bottom-0 left-1/2 -translate-x-1/2 translate-y-1/2 w-3/4 h-1/2 bg-primary/10 blur-[100px] rounded-full -z-10 pointer-events-none" />

          <h2 className="text-4xl md:text-5xl font-syne font-black tracking-tight mb-6 max-w-2xl mx-auto">
          ...
          <p className="mt-6 text-sm text-muted-foreground opacity-80">
